<script setup>
// Original from https://github.com/mattcone/markdown-guide/blob/master/getting-started.md
const markdown = `## What is Markdown?
...
You'll probably want to keep the Dillinger website open as you read through this guide. That way you can try the syntax as you learn about it. After you've become familiar wittoph Markdown, you may want to use a Markdown application that can be installed on your desktop computer or mobile device.
...
const markdownElements = converted.split('<h').map((x) => "<h" + x)

useHead({
    title: "Getting Started on Markdown"
})
</script>
<template>
<div class="wrapper">
    <div class="sidebar">
        <AdView v-for="i in 3" width="160" height="270" />
    </div>
    <div class="main">
        <h1>Getting Started on Markdown</h1>
        <div v-for="element in markdownElements" class="element">
            <div v-html="element"></div>
            <AdView class="ad" width="600" height="500" />
        </div>
    </div>
    <div class="sidebar">
        <AdView v-for="i in 3" width="160" height="270" />
